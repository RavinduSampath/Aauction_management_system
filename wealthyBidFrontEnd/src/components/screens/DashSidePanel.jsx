  ...
  const fetchUnreadNotificationsCount = async () => {
    try {
      const response = await fetch(
        "https://localhost:7216/api/notifications/check",
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      ...
      <button
        ...
        type="button"
        className="absolute inline-flex flex-row-reverse items-center p-2 text-sm text-black border-2 border-gray-800 rounded-lg right-5 sm:hidden hover:bg-gray-200"
      >
      ...
      <aside
        id="default-sidebar"
        className={`fixed top-0 left-0 z-40 w-64 h-screen transition-transform bg-[#48a616] sm:translate-x-0 ${
