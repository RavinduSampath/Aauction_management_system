...
const Navbar = ({ user, setUser }) => {
  ...
  return (
    <nav className="relative z-50">
      <div className="bg-[#004d00] text-white shadow-lg">
          ...
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center space-x-2">
              <img
                src="/Bidoutlogo.png"
                alt="Bid Logo"
                className="h-10 w-10 sm:h-12 sm:w-12 lg:h-14 lg:w-14 border-0 border-whit-400"
              />
              <Link to="/" className="text-2xl- font-bold">
                <span className="text-yellow-400">wealthy</span>Bid
              </Link>
            </div>
            ...
            <div className="hidden md:flex space-x-6 items-center">
              <Link
                to="/"
                className="hover:text-yellow-400 text-base font-medium"
              >
                Home
              </Link>
              {user && (
